...
export function buildExplainFunctionPrompt(input: ExplainFunctionInput): string {
  return [
    ...
    '  "risks": array of potential edge cases, bugs, or performance concerns',
    '  "connectedFlow": array showing how this function connects to callers and callees',
    '  "confidence": number 0-1 indicating how confident you are in this explanation',
    "",
    ...
    "- For risks, focus on real-world issues: null checks, race conditions, performance, security",
    "",
    `--- CODE CONTEXT ---`,
...
export function buildExplainCallFlowPrompt(input: ExplainCallFlowInput): string {
  return [
    ...
    '  "flowSteps": array of strings describing the execution flow step-by-step, including function entries and exits',
    ...
    '  "edgeCases": array of unusual execution paths or failure scenarios',
    "",
    `--- CONTEXT ---`,
